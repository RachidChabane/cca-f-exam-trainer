...
const en = {
  ...
  pauseExam: 'Pause the timer',
  timerPaused: 'Timer paused',
  timerPausedReading: 'Timer paused while you read — it resumes on the next question.',
  pausedTitle: 'Exam paused',
  pausedBody: 'The timer is stopped and the question is hidden. Resume when you’re ready to continue.',
  flag: 'Flag',
  flagged: 'Flagged',
  unflag: 'Unflag',
  previous: 'Previous',
...
const fr: typeof en = {
  ...
  pauseExam: 'Mettre le chronomètre en pause',
  timerPaused: 'Chronomètre en pause',
  timerPausedReading: 'Chronomètre en pause pendant votre lecture — il reprend à la question suivante.',
  pausedTitle: 'Examen en pause',
  pausedBody: 'Le chronomètre est arrêté et la question est masquée. Reprenez quand vous êtes prêt à continuer.',
  flag: 'Marquer',
  flagged: 'Marquée',
